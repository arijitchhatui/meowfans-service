...
export class Rdb_1756561869266 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_CREATOR_RESTRICTS_FAN_ID_CREATOR_ID" ON "creator_restricts" ("fan_id", "creator_id") `,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_MESSAGE_CHANNELS_LAST_MESSAGE_ID" ON "message_channels" ("last_message_id") `,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_SUBSCRIPTIONS_CREATOR_ID_FAN_ID" ON "subscriptions" ("creator_id", "fan_id") `,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_CREATOR_BLOCKS_CREATOR_ID_FAN_ID" ON "creator_blocks" ("creator_id", "fan_id") `,
    );

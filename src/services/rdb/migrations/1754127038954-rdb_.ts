...
export class Rdb_1754127038954 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "posts" DROP COLUMN "type"`);
        await queryRunner.query(`CREATE TYPE "public"."posts_type_enum" AS ENUM('PUBLIC', 'EXCLUSIVE', 'PRIVATE', 'ARCHIVED', 'HIDDEN', 'BANNED')`);
        await queryRunner.query(`ALTER TABLE "posts" ADD "type" "public"."posts_type_enum" array NOT NULL DEFAULT '{EXCLUSIVE}'`);
    }

...
export class Rdb_1753210005356 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "creator_profiles" ADD CONSTRAINT "UQ_817b1f769b78e0bb2e577442d07" UNIQUE ("username")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "fan_profiles" ADD CONSTRAINT "UQ_9c968f59530c36324cf0746edd8" UNIQUE ("username")`,
    );
